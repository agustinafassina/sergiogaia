...
<style>
    ...
    padding: 8px;}
      ...
      <div class="row" style="margin: 15px;">
        <div class="col-sm-9">
            <h3>PLANILLA DE TURNOS YOGA CREATIVO</h3>
            <ul>
      ...
      <div class="divRu"> 
       <table id="psicologia" class="display" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <?php 
            $sql = "SELECT * FROM reservas WHERE id_profesion='2' AND realizado='0' ORDER by fecha_reserva desc,id_hora";
      ...
      <div class="divRu"> 
       <table id="psicologiaRealizados" class="display" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <?php 
            $sqlA = "SELECT * FROM reservas WHERE id_profesion='2' AND realizado='1'  ORDER by fecha_reserva desc,id_hora";
           // mysqli_set_charset($con, "utf8");
           ...
           if (!$resultA=mysqli_query($con,$sqlA));
            ...
            <tr>
              ...
              <td><?php echo date("d-m-Y", strtotime($rowA['fecha'])) ?><br>Ingreso: <?php echo $rowA1['ingreso'] ?></td>
